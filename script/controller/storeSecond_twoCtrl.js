define(['app','css!../css/storeSecond_two.css','jquery','services','swipper'],function(app){
    app.controller('storeSecond_twoCtrl',['$scope','indexfunc','$http','carousel','footerfunc',function ($scope,indexfunc,$http,carousel,footerfunc) {
        $scope.name = 'store';
        indexfunc.initjs();
        footerfunc.footerSh();
